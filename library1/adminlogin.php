...
$sql ="SELECT UserName,Password FROM admin1 WHERE UserName=:username and Password=:password";
...
<header class="masthead">
      <div class="container">
        ...
        <div class="intro-lead-in">LOGIN AS<br>   ADMIN</div>
...
<input class="form-control" type="password" name="password" autocomplete="off" required />
 ...
 <div class="form-group">
     <br>
<label><h4>Verification Code :</h4> </label>
<input type="text"  name="vercode" maxlength="5" autocomplete="off" required style="width: 150px; height: 25px;" />&nbsp;<img src="captcha.php">
</div>  

 <button type="submit" name="login" class="btn btn-info"><b>LOGIN</b> </button>



                <a href="logout.php" class="btn btn-danger pull-right">EXIT</a>
        ...
        <div class="row">
          <div class="col-sm-4">
            <div class="team-member">
              ...
              <h4>Muhammad Sameer Ahmed Sheikh</h4>
